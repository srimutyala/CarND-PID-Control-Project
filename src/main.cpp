...
int main()
{
	...
	//pid.Init(0.185, 0.003, 3.5);
	pid_s.Init(0.1, 0.0002, 3.00);
			...
			if (s != "") {
				...
				if (event == "telemetry") {
					...
					*/
					...
					//throttle_value = 0.90 - pid_t.Kp * pid_t.p_error - pid_t.Kd * pid_t.d_error - pid_t.Ki * pid_t.i_error;
					throttle_value = 0.80 - pid_t.Kp * pid_t.p_error - pid_t.Kd * pid_t.d_error - pid_t.Ki * pid_t.i_error;
					...
					//msgJson["throttle"] = (1 - std::abs(steer_value)) * 0.45 + 0.25;
